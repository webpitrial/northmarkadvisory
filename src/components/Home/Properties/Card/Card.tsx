      ...
      <div className='relative rounded-2xl border border-dark/10 dark:border-white/10 group hover:shadow-3xl duration-300 dark:hover:shadow-white/20'>
        ...
        <div className='p-6'>
          <div className='flex flex-col mobile:flex-row gap-5 mobile:gap-0 justify-between mb-6'>
            <div>
              <Link href={`/properties/${slug}`}>
                <h3 className='text-xl font-medium text-black dark:text-white duration-300'>
                  {name}
                </h3>
              </Link>
            ...
            <div>
              <button className='text-base font-normal text-dark bg-dark/5 dark:text-white px-5 py-2 rounded-full dark:bg-primary/10'>
                ${rate}
              </button>
            </div>
          </div>
